...
import numpy as np
import pysubgroupx as ps
from functools import total_ordering
from pysubgroupx.measures import AbstractInterestingnessMeasure, \
    BoundedInterestingnessMeasure
from pysubgroupx.utils import conditional_invert
...
class StandardQF_numeric (AbstractInterestingnessMeasure, BoundedInterestingnessMeasure):
    ...
    def evaluateFromDataset(self, data, subgroup, weightingAttribute=None, cache=None):
    ...
    def evaluateFromStatistics (self, instances_dataset, mean_dataset, instances_subgroup, mean_sg):
        return StandardQF_numeric.standardQF_numeric (self.a, instances_dataset, mean_dataset, instances_subgroup, mean_sg)
